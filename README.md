...
- **Goal-Oriented Macro Splits**: Automatically scales caloric intake and macronutrient profiles depending on the selected goal:
  ...
  - **Maintain**: Baseline TDEE, balanced macro split.
  - **Gain Muscle**: 500 kcal surplus, high carbohydrate structure for optimal energy and recovery.
- **Premium UI Design**: Features a beautiful dark-mode interface with a CSS-based glassmorphism aesthetic, sleek blur effects, and vibrant neon accents.
- **Data Visualization**: Smooth micro-animations and dynamic CSS progress bars visually output the user's protein, carbs, and fat distributions.
